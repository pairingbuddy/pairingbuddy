...
For spike setup, this means presenting:
- The spike goal
- Exploration mode (questions/approaches/comparison)
- Code location
- Each unit with: name, description, language, working directory, and run command
