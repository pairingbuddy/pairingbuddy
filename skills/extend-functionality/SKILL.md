---
name: extend-functionality
description: Extend existing features using TDD while maintaining consistency
---

# Extend Functionality

Extend existing functionality using TDD.

## Workflow Rules (CRITICAL - Follow Exactly)

**Phase 0: UNDERSTAND** (Mandatory)
- Read [phase-0-understand-existing](modules/phase-0-understand-existing.md)
- Understand existing code patterns and architecture
- Enumerate test scenarios for the extension
...
2. **GREEN** → Read [phase-green](_shared/modules/phase-green.md) - Make test pass with minimal code
