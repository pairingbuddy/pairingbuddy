...
Extract separate classes with focused responsibilities.
...
Use polymorphism with gateway interfaces.
...
After all checks, ensure your design follows these rules in priority order:
