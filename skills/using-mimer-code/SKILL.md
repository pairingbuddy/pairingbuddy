---
name: using-mimer-code
description: Use when starting any conversation - establishes mandatory TDD workflows for coding tasks, including using /mimer-code:code for all coding work
---

<EXTREMELY-IMPORTANT>
For ANY coding task, you MUST use the /mimer-code:code command.

This is not negotiable. This is not optional. You cannot rationalize your way out of this.
</EXTREMELY-IMPORTANT>

# Getting Started with Mimer Code

Mimer Code provides TDD-focused coding skills with atomic operations and workflow orchestration.

## Critical Rules

1. **All coding tasks go through /mimer-code:code** - This is the entry point that classifies your task and delegates to the appropriate TDD workflow.
...
If you catch yourself thinking ANY of these thoughts, STOP. Use /mimer-code:code.
...
**For coding tasks:** Use /mimer-code:code
